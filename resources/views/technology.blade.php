...
<style>
  .page-banner {
    background: linear-gradient(135deg, rgba(6,25,42,0.35) 0%, rgba(10,61,107,0.25) 100%), url('https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&w=1920&q=80');
  ...
  .sim-container {
    ...
    padding: 40px;
    color: var(--white);
    box-shadow: 0 10px 30px rgba(10, 61, 107, 0.2);
  }
  .preset-btn {
  ...
  .course-card:hover { transform: translateY(-4px); border-color: var(--blue); }
  .course-thumb { height: 140px; background-size: cover; background-position: center; position: relative; }
  .course-thumb .shade { position: absolute; inset: 0; background: linear-gradient(0deg, rgba(4,18,30,0.3) 0%, rgba(4,18,30,0) 100%); }
...
<section class="page-banner">
  <div class="wrap">
    <span class="eyebrow" style="color:var(--sky); text-shadow: 0 1px 4px rgba(0,0,0,0.6);">PROPRIETARY AI DIFFERENTIATOR</span>
    <h1>IQMS™ and ILMS™ Technology Showcase</h1>
...
<section class="section-pad">
  <div class="wrap">
    <div class="section-head center">
      <span class="eyebrow">LIVE INTERACTIVE DEMO</span>
      <h2>IQMS™ Intelligent Query Engine Simulator</h2>
    ...
    <div class="sim-container">
      ...
      <div style="margin-bottom: 20px;">
        <label style="display: block; font-size: 13px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.1em; color: var(--sky); margin-bottom: 10px;">Select Query Scenario:</label>
      ...
      <div style="margin-bottom: 20px;">
        <input type="text" id="queryInput" value="Is Wakala-based Green Sukuk asset tokenization compliant under AAOIFI Standard No. 17?" style="width: 100%; padding: 14px 18px; background: rgba(255,255,255,0.08); border: 1px solid rgba(255,255,255,0.25); border-radius: var(--radius); color: #fff; font-size: 15px; font-family: inherit;">
      </div>
...
<!-- Blue Box Highlight ILMS Section with Images -->
<section class="section-pad" id="ilms" style="background: var(--pale);">
  <div class="wrap">
    
    <div class="blue-box" style="background: linear-gradient(135deg, rgba(10,61,107,0.45), rgba(22,113,196,0.35)), url('https://images.unsplash.com/photo-1524178232363-1fb2b075b655?auto=format&fit=crop&w=1200&q=80'); background-size: cover; margin-bottom: 40px;">
      <span class="eyebrow" style="color: var(--sky); text-shadow: 0 1px 4px rgba(0,0,0,0.6);">ILMS™ CAPACITY BUILDING PLATFORM</span>
      <h3 style="font-size: 28px; margin-bottom: 14px; text-shadow: 0 1px 4px rgba(0,0,0,0.6);">Structured Digital Learning for Boards &amp; Staff</h3>
      <p style="font-size: 16px; margin-bottom: 20px; text-shadow: 0 1px 3px rgba(0,0,0,0.6);">A dedicated learning management system providing certified executive modules, board member orientation, and staff regulatory readiness programs under AAOIFI guidelines.</p>
      <a href="{{ url('/speak-with-us') }}" class="btn ghost-light">Request ILMS Demo Access</a>
    </div>

    <!-- ILMS Course Cards with Photo Thumbnails -->
